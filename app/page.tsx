  ...
  return (
    <div className="min-h-screen bg-black text-white py-20 px-10">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-5xl font-bold mb-4 text-white">Já Perdes</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div key={plan.name} className="border border-gray-800 p-8 rounded-2xl bg-zinc-900 flex flex-col justify-between hover:border-blue-500 transition-all">
              <div>
